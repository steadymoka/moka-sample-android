package com.moka.framework.stickerview;
...
import com.moka.framework.stickerview.drawable.EditableDrawable;
import com.moka.framework.stickerview.drawable.FeatherDrawable;
import com.moka.framework.stickerview.imagezoom.ImageViewTouch;
import com.moka.framework.stickerview.util.Point2D;
import com.moka.framework.util.ScreenUtil;
import com.moka.framework.stickerview.util.UIUtils;
...
public class MyHighlightView implements EditableDrawable.OnSizeChange {
	...
	public void setScaleable(boolean scaleable) {
		...
		if ( scaleable ) {
			mAnchorRotate = MokaToyApplication.Companion.getContext().getResources().getDrawable(R.mipmap.aviary_resize_knob);
		}
		else {
			mAnchorRotate = null;
		}
	...
	public void setDeleteable(boolean deleteable) {
		if ( deleteable ) {
			mAnchorDelete = MokaToyApplication.Companion.getContext().getResources().getDrawable(R.mipmap.aviary_delete_knob);
		}
		else {
			mAnchorDelete = null;
		}
	...
	public void draw(final Canvas canvas) {
		...
		if ( is_selected || is_focused ) {
			...
			if ( mShowAnchors ) {
				...
				outlinePaint.setStrokeWidth((float) ScreenUtil.Companion.dipToPixel(MokaToyApplication.Companion.getContext(), 1));
